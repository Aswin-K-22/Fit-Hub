// src/presentation/features/admin/pages/Gyms.tsx
...
import { GetGymsUseCase } from "../../../../app/useCases/admin/getGyms";

const adminRepository = new AdminRepository();
const getGymsUseCase = new GetGymsUseCase(adminRepository);
...
const Gyms: React.FC = () => {
  ...
  useEffect(() => {
    const fetchGyms = async () => {
      try {
        const { gyms, total, totalPages } = await getGymsUseCase.execute(page, limit);
        setGyms(gyms);
        setTotalGyms(total);
