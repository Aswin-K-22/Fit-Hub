...
import { GetMembershipPlansUseCase } from "../../../../app/useCases/admin/getMembershipPlans";

const adminRepository = new AdminRepository();
const getMembershipPlansUseCase = new GetMembershipPlansUseCase(adminRepository);
...
const MembershipPlans: React.FC = () => {
  ...
  useEffect(() => {
    const loadPlans = async () => {
      setLoading(true);
      try {
        const { plans, total, pages } = await getMembershipPlansUseCase.execute(page, limit);
        setPlans(plans);
        setTotalPlans(total);
        setTotalPages(pages);
      } catch (error) {
