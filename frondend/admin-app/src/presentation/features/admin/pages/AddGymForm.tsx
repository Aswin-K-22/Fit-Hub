...
import { AddGymUseCase, GetAvailableTrainersUseCase } from "../../../../app/useCases/admin/addGym";
import { IAddGymRequestDTO } from "../../../../domain/dtos/admin/IAddGymRequestDTO";

const adminRepository = new AdminRepository();
const addGymUseCase = new AddGymUseCase(adminRepository);
const getAvailableTrainersUseCase = new GetAvailableTrainersUseCase(adminRepository);
...
const AddGymForm: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTrainers = async () => {
      try {
        const trainers = await getAvailableTrainersUseCase.execute();
  ...
  const onSubmit = async (data: GymFormData) => {
    ...
    try {
      await addGymUseCase.execute(formDataToSend);
