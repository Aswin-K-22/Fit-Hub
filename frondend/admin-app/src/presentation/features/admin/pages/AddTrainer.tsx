// src/presentation/features/admin/pages/AddTrainer.tsx
import React, { useState, FormEvent } from "react";
import { useNavigate } from "react-router-dom";
import { toast } from "react-toastify";
import { AxiosError } from "axios";
import { AdminRepository } from "../../../../infra/api/adminApi";
import { AddTrainerUseCase } from "../../../../app/useCases/admin/addTrainer";
import { IAddTrainerDataDTO } from "../../../../domain/dtos/trainer/IAddTrainerDataDTO";
import Select from "react-select";

const adminRepository = new AdminRepository();
const addTrainerUseCase = new AddTrainerUseCase(adminRepository);

const AddTrainer: React.FC = () => {
  const navigate = useNavigate();
  const [formData, setFormData] = useState<IAddTrainerDataDTO>({
    name: "",
    email: "",
    password: "",
    specialties: [],
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await addTrainerUseCase.execute(formData);
