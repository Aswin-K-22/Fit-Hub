...
import { GetTrainerDetailsUseCase } from "../../../../app/useCases/admin/getTrainerDetails";
import { ApproveTrainerUseCase } from "../../../../app/useCases/admin/approveTrainer";

const adminRepository = new AdminRepository();
const getTrainerDetailsUseCase = new GetTrainerDetailsUseCase(adminRepository);
...
const TrainerDetails: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTrainer = async () => {
      try {
        const response = await getTrainerDetailsUseCase.execute(id!);
  ...
  const handleApprove = async () => {
    try {
      await approveTrainerUseCase.execute(id!);
