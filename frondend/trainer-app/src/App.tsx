...
const ForbiddenPage = React.lazy(() => import("@/presentation/features/trainer/pages/ForbiddenPage"));
...
const ProtectedRoute: React.FC<{ element: JSX.Element; allowedRoles: string[]; isPublic?: boolean }> = ({
  ...
  const userRole = trainer?.role || "";
  const isTrainerApproved = trainer?.verifiedByAdmin || false;
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            <Route element={<TrainerLayout />}>
              ...
              <Route path="/trainer/profile" element={<ProtectedRoute element={<TrainerProfile />} allowedRoles={["trainer"]} />} />
            </Route>
