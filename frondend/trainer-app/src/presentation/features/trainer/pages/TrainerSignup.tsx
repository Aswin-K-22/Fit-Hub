...
import { SignupTrainerUseCase } from "../../../../app/useCases/trainer/signupTrainer";
import { ITrainerSignupRequestDTO } from "../../../../domain/dtos/trainer/ITrainerSignupRequestDTO";

const trainerRepository = new TrainerRepository();
const signupTrainerUseCase = new SignupTrainerUseCase(trainerRepository);
...
const TrainerSignup: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      await signupTrainerUseCase.execute(formData);
