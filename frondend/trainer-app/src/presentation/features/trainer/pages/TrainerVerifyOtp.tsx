...
import { VerifyTrainerOtpUseCase } from "../../../../app/useCases/trainer/verifyTrainerOtp";
import { ResendTrainerOtpUseCase } from "../../../../app/useCases/trainer/resendTrainerOtp";

const trainerRepository = new TrainerRepository();
const verifyTrainerOtpUseCase = new VerifyTrainerOtpUseCase(trainerRepository);
const resendTrainerOtpUseCase = new ResendTrainerOtpUseCase(trainerRepository);
...
const TrainerVerifyOtp: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      await verifyTrainerOtpUseCase.execute({ email, otp });
  ...
  const handleResendOtp = async () => {
    ...
    setLoading(true);
    try {
      await resendTrainerOtpUseCase.execute({ email });
