...
import { FetchGymsUseCase } from "../../../../app/useCases/user/fetchGyms";
...
const fetchGymsUseCase = new FetchGymsUseCase(userRepository);
...
const GymSearchPage: React.FC = () => {
  ...
  const loadGyms = useCallback(async () => {
    setLoading(true);
    try {
      const params: Parameters<typeof fetchGymsUseCase.execute>[0] = {
        page,
        limit,
        search: searchQuery,
      ...
      const response = await fetchGymsUseCase.execute(params);
