...
import { signup } from "../../../../infra/api/userApi";
import { toast } from "react-toastify";
import { AppDispatch } from "../../../../infra/redux/store"; // [Change 1 - Line 9]: Import AppDispatch
...
const LoginSignup: React.FC = () => {
  ...
  const handleLoginSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const result = await dispatch(loginThunk(loginData)); // [Change 3 - Line 130]: Await dispatch
