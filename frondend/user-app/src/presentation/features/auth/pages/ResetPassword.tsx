...
import { resetPassword } from "../../../../infra/api/userApi";
import { toast } from "react-toastify";
import Navbar from "@/presentation/features/user/components/Navbar";
...
const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await resetPassword(email, otp, formData.newPassword); // [Fix - Line 74]: Pass arguments separately
