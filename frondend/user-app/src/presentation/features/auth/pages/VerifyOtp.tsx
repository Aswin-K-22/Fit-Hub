...
import { setAuth } from "../../../../infra/redux/slices/authSlice"; // [Change 1 - Line 5]: Import setAuth
import { toast } from "react-toastify";
import OtpInput from "react-otp-input";
import Footer from "../../../components/Footer";
import { verifyOtp, resendOtp, verifyForgotPasswordOtp } from "../../../../infra/api/userApi"; // [Change 2 - Line 9]: Import API functions
import { AppDispatch } from "../../../../infra/redux/store"; // [Change 3 - Line 10]: Import AppDispatch

const VerifyOtp: React.FC = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch<AppDispatch>(); // [Change 4 - Line 14]: Use AppDispatch
